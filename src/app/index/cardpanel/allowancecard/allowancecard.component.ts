...
@Component({
  selector: 'app-allowancecard',
  templateUrl: './allowancecard.component.html',
  styleUrls: ['./allowancecard.component.css']
})
export class AllowancecardComponent implements OnInit {
  // Variables ----------------
